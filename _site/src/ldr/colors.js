...
LDR.Colors[5] = {
  ...
  value: 0xd3359d,
  edge: 0x333333,
  lego_name: "Medium Reddish Violet",
  lego_id: 22,
  lego_name2: "Bright Purple",
  lego_id2: 221,
...
LDR.Colors[35] = {
  ...
  value: 0x56e646,
  edge: 0x27af18,
  lego_name: "Transparent Bright Green",
  lego_id: 311,
...
LDR.Colors[75] = {
  ...
  bricklink_id: 116,
  material: "MATERIAL SPECKLE VALUE #AB6038 FRACTION 0.4 MINSIZE 1 MAXSIZE 3",
};
LDR.Colors[76] = {
  ...
  bricklink_id: 117,
  material: "MATERIAL SPECKLE VALUE #898788 FRACTION 0.4 MINSIZE 1 MAXSIZE 3",
};
LDR.Colors[77] = {
  name: "Light_Pink",
  value: 0xfecccf,
...
LDR.Colors[80] = {
  ...
  value: 0x767676,
  edge: 0x333333,
  lego_name: "Cool Silver Drum Lacq",
  lego_id: 298,
  lego_name2: "Silver Ink",
  lego_id2: 336,
...
LDR.Colors[114] = {
  ...
  value: 0xdf6695,
  edge: 0xb9275f,
  lego_name: "Transparent Medium Reddish-Violet w. Glitter 2%",
  lego_id: 114,
  bricklink_name: "Glitter Trans-Dark Pink",
  bricklink_id: 100,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #B92790 FRACTION 0.17 VFRACTION 0.2 SIZE 1",
};
LDR.Colors[115] = {
  name: "Medium_Lime",
  value: 0xb7d425,
...
LDR.Colors[117] = {
  ...
  bricklink_id: 101,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #FFFFFF FRACTION 0.08 VFRACTION 0.1 SIZE 1",
};
LDR.Colors[118] = {
  name: "Aqua",
  value: 0x9cd6cc,
...
LDR.Colors[129] = {
  ...
  value: 0x640061,
  edge: 0x000000,
  lego_name: "Transparent Bright Bluish Violet w. Glitter 2%",
  lego_id: 129,
  bricklink_name: "Glitter Trans-Purple",
  bricklink_id: 102,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #8F00CC FRACTION 0.03 VFRACTION 0.4 SIZE 1",
};
LDR.Colors[132] = {
...
LDR.Colors[133] = {
  ...
  bricklink_id: 151,
  material: "MATERIAL SPECKLE VALUE #DBAC34 FRACTION 0.4 MINSIZE 1 MAXSIZE 3",
};
LDR.Colors[134] = {
  name: "Copper",
  value: 0x764d3b,
...
LDR.Colors[135] = {
  ...
  value: 0xa0a0a0,
  edge: 0x333333,
  lego_name: "Cool Silver",
  lego_id: 296,
  lego_name2: "Silver",
  lego_id2: 131,
  lego_name3: "Silver Metallic",
  lego_id3: 315,
...
LDR.Colors[227] = {
  ...
  value: 0xb5d96c,
  edge: 0x86b22e,
  lego_name: "Transparent Bright Yellowish Green",
  lego_id: 227,
  alpha: 128,
};
LDR.Colors[231] = {
...
LDR.Colors[300] = {
  ...
  value: 0xc27f53,
  edge: 0x333333,
  lego_name: "Copper Drum Lacq",
  lego_id: 300,
  lego_name2: "Copper Ink",
  lego_id2: 334,
  material: "METAL",
};
LDR.Colors[302] = {
  ...
  value: 0xaee9ef,
  edge: 0x59d1de,
  lego_name: "Transparent Light Blue with Glitter 2%",
  lego_id: 302,
  bricklink_name: "Glitter Trans-Light Blue",
  bricklink_id: 162,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #59DEBF FRACTION 0.17 VFRACTION 0.2 SIZE 1",
};
LDR.Colors[308] = {
  name: "Dark_Brown",
  value: 0x352100,
...
LDR.Colors[339] = {
  ...
  value: 0xc0ff00,
  edge: 0x739900,
  lego_name: "Transparent Fluorescent Green with Glitter 2%",
  lego_id: 339,
  bricklink_name: "Glitter Trans-Neon Green",
  bricklink_id: 163,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #998C00 FRACTION 0.17 VFRACTION 0.2 SIZE 1",
};
LDR.Colors[341] = {
  name: "Glitter_Trans_Orange",
  value: 0xf08f1c,
  edge: 0x9e5c0a,
  lego_name: "Transparent Bright Orange with Glitter 2%",
  lego_id: 341,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #9E2A0A FRACTION 0.17 VFRACTION 0.2 SIZE 1",
};
LDR.Colors[350] = {
  name: "Rubber_Orange",
  value: 0xd67923,
...
LDR.Colors[362] = {
  ...
  luminance: 5,
  material:
    "MATERIAL GLITTER VALUE #59DEBF FRACTION 0.8 VFRACTION 0.6 MINSIZE 0.02 MAXSIZE 0.1",
};
LDR.Colors[363] = {
  name: "Opal_Trans_Black",
  value: 0x635f52,
  edge: 0x2a2823,
  lego_name: "Transparent Brown Opal",
  lego_id: 363,
  alpha: 200,
  luminance: 5,
  material:
    "MATERIAL GLITTER VALUE #292522 FRACTION 0.8 VFRACTION 0.6 MINSIZE 0.02 MAXSIZE 0.1",
};
LDR.Colors[364] = {
  name: "Opal_Trans_Dark_Pink",
  value: 0xdf6695,
  edge: 0xb9275f,
  lego_name: "Transparent Medium Reddish Violet Opal",
  lego_id: 364,
  alpha: 200,
  luminance: 5,
  material:
    "MATERIAL GLITTER VALUE #B92790 FRACTION 0.8 VFRACTION 0.6 MINSIZE 0.02 MAXSIZE 0.1",
};
LDR.Colors[365] = {
  name: "Opal_Trans_Purple",
  value: 0x671f81,
  edge: 0x441456,
  lego_name: "Transparent Violet Opal",
  lego_id: 365,
  alpha: 200,
  luminance: 5,
  material:
    "MATERIAL GLITTER VALUE #2F1456 FRACTION 0.8 VFRACTION 0.6 MINSIZE 0.02 MAXSIZE 0.1",
};
LDR.Colors[366] = {
  name: "Earth_Orange",
  value: 0xd86d2c,
...
LDR.Colors[367] = {
  ...
  value: 0x237841,
  edge: 0x174f2b,
  lego_name: "Transparent Green Opal",
  lego_id: 367,
  alpha: 200,
  luminance: 5,
  material:
    "MATERIAL GLITTER VALUE #0B270B FRACTION 0.8 VFRACTION 0.6 MINSIZE 0.02 MAXSIZE 0.1",
};
LDR.Colors[368] = {
  name: "Vibrant_Yellow",
  value: 0xedff21,
  edge: 0x333333,
  lego_name: "Vibrant Yellow",
  lego_id: 368,
};
LDR.Colors[373] = {
  name: "Sand_Purple",
...
LDR.Colors[10351] = {
  ...
  value: 0x56e646,
  edge: 0x27af18,
  lego_name: "Transparent Bright Green with Glitter 2%",
  lego_id: 351,
  alpha: 128,
  material: "MATERIAL GLITTER VALUE #59AF18 FRACTION 0.17 VFRACTION 0.2 SIZE 1",
};
LDR.Colors[10366] = {
  ...
  luminance: 5,
  material:
    "MATERIAL GLITTER VALUE #001D38 FRACTION 0.8 VFRACTION 0.6 MINSIZE 0.02 MAXSIZE 0.1",
};
LDR.Colors[10378] = {
